...
export default function SummaryScreen({ event, mapScore, yearScore, totalScore, isLastRound, round, totalRounds, onNext, onFinish }: Props) {
    ...
    <div className="relative min-h-screen bg-[#C8B88A] p-6 flex flex-col items-center gap-6">
        ...
        <div className="bg-white rounded-2xl px-10 py-4 w-full max-w-lg text-center" style={{ border: '2px solid #a89060' }}>
            ...
            <p className="text-4xl font-black" style={{ color: `hsl(${(totalScore / ((round + 1) * 100)) * 120}, 80%, 40%)` }}>
